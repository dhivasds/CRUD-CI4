...
<div class="container">
    <div class="row">
        <div class="col-8">
            ...
            <!-- dapet $komik darimana? karna sudah di kirim di controllernya 'komik' -->
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            <input type="file" class="form-control <?= ($validation->hasError('sampul')) ? 'is-invalid' : ''; ?>" id="sampul" aria-describedby="inputGroupFileAddon04" aria-label="Upload" name="sampul">
                            <div id="validationServer03Feedback" class="invalid-feedback">
